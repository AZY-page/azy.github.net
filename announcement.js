...
const announcements = [
  {
    id: 1,
    title: '油猴插件更新通知',
    content: '油猴插件版已更新感谢<头发会炸毛>的赞助，<a href="https://pan.tenire.com/down.php/795a1e333ab290bdd658b3e034ae3a29.7z" class="download-link inline-flex items-center px-4 py-2 bg-primary text-white rounded-full hover:bg-primary/90 transition-all hover:shadow-md">【点击下载】<i class="fa fa-download ml-2"></i></a>',
